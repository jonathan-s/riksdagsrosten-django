...
class Migration(SchemaMigration):
    ...
    models = {
        'riksdagen.document': {
            ...
            'hangar_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'unique': 'True'}),
        ...
        'riksdagen.voting': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'db_column': "'hangar_id'", 'to': "orm['riksdagen.Document']", 'to_field': "'hangar_id'"}),
