...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Voting', fields ['hangar_id']
        db.create_index('riksdagen_voting', ['hangar_id'])

        # Adding index on 'Document', fields ['hangar_id']
        db.create_index('riksdagen_document', ['hangar_id'])


    def backwards(self, orm):
        # Removing index on 'Document', fields ['hangar_id']
        db.delete_index('riksdagen_document', ['hangar_id'])

        # Removing index on 'Voting', fields ['hangar_id']
        db.delete_index('riksdagen_voting', ['hangar_id'])
