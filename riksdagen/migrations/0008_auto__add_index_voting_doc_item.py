...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Voting', fields ['doc_item']
        db.create_index('riksdagen_voting', ['doc_item'])


    def backwards(self, orm):
        # Removing index on 'Voting', fields ['doc_item']
        db.delete_index('riksdagen_voting', ['doc_item'])
