...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Document', fields ['doc_id']
        db.create_index('riksdagen_document', ['doc_id'])


    def backwards(self, orm):
        # Removing index on 'Document', fields ['doc_id']
        db.delete_index('riksdagen_document', ['doc_id'])
