...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('riksdagen_document', 'summary',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('riksdagen_document', 'summary')
    ...
    models = {
        ...
        'riksdagen.voting': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'doc_votes'", 'db_column': "'hangar_id'", 'to': "orm['riksdagen.Document']"}),
        ...
        'riksdagen.votingagg': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'voting_agg'", 'unique': 'True', 'db_column': "'hangar_id'", 'to': "orm['riksdagen.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
