...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.hangar_id'
        db.add_column('riksdagen_document', 'hangar_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.hangar_id'
        db.delete_column('riksdagen_document', 'hangar_id')
