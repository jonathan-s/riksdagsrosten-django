...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('riksdagen_document', 'id')

    def backwards(self, orm):
        db.add_column('riksdagen_document', 'id',
    ...
    models = {
        ...
        'riksdagen.voting': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'doc_votes'", 'to': "orm['riksdagen.Document']"}),
        ...
        'riksdagen.votingagg': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voting_agg'", 'to': "orm['riksdagen.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
